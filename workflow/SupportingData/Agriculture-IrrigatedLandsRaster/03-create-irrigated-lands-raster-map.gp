# Create a GeoMapProject file for irrigated lands raster map
...
SetProperty(PropertyName="MapFolder",PropertyType="str",PropertyValue="${MapsFolder}/SupportingData/Agriculture-IrrigatedLandsRaster")
SetProperty(PropertyName="WWRRepoFolder",PropertyType="str",PropertyValue="../../../../owf-infomapper-coagtransfer-data-wwr")
#
# Create a single map project and map for that project.
# - GeoMapProjectID:  IrrigatedLandsRasterProject
# - GeoMapID:  IrrigatedLandsMap
CreateGeoMapProject(NewGeoMapProjectID="IrrigatedLandsRasterProject",ProjectType="SingleMap",Name="Irrigated Lands",Description="Irrigated lands.",Properties="author:'Open Water Foundation',specificationVersion:'1.0.0'")
...
AddGeoMapToGeoMapProject(GeoMapProjectID="IrrigatedLandsRasterProject",GeoMapID="IrrigatedLandsMap")
# = = = = = = = = = =
...
WriteGeoMapProjectToJSON(GeoMapProjectID="IrrigatedLandsRasterProject",Indent="2",OutputFile="irrigated-lands-raster-map.json")
CreateFolder(Folder="${MapFolder}/layers",CreateParentFolders="True",IfFolderExists="Ignore")
CopyFile(SourceFile="irrigated-lands-raster-map.json",DestinationFile="${MapFolder}/irrigated-lands-raster-map.json")
CopyFile(SourceFile="irrigated-lands-raster-map.md",DestinationFile="${MapFolder}/irrigated-lands-raster-map.md")
# Rasters
