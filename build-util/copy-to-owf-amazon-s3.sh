...
#
# Copy the staged Info Mapper website to the coagtransfer.openwaterfoundation.org website
...
# Get the InfoMapper version and Colorado Agricultural Water Transfer Information Portal version.
...
printUsage() {
  ...
  echoStderr ""
  echoStderr "Copy the Colorado Agriculture Water Transfer application files to the Amazon S3 static website folder(s),"
...
printVersion() {
  ...
  echoStderr ""
  echoStderr "Colorado Agricultural Water Transfer"
...
s3FolderVersionUrl="s3://coagtransfer.openwaterfoundation.org/${version}"
s3FolderLatestUrl="s3://coagtransfer.openwaterfoundation.org/latest"
