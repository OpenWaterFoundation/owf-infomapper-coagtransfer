...
[software repository issues page](https://github.com/OpenWaterFoundation/owf-infomapper-coagtransfer)
...
| **Map is slow to load.** | Some maps display large datasets and are slow to load.  The website is being updated to provide data loading feedback.  Viewing complex maps may require more computer memory and faster internet for better performance. Menus for maps with large data sets are labeled to warn the user. |
